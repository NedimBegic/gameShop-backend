...
exports.deleteSingleGameController =
  exports.postGameController =
  exports.getSingleGameController =
  exports.getAllGamesController =
    void 0;
...
// METHOD: GET,
// DESC: get all games
exports.getAllGamesController = (0, async_1.default)((req, res, next) =>
...
exports.getSingleGameController = (0, async_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.postGameController = (0, async_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.deleteSingleGameController = (0, async_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const gameForDelete = yield (0, gamesModel_1.getSingleGame)(req.params.id);
    if (
      req.user.user_id !=
      (gameForDelete === null || gameForDelete === void 0
        ? void 0
        : gameForDelete.user_id)
    ) {
      return next(
        new errorResponse_1.default(
          "User not authorized to delete this game",
          404
        )
      );
    }
    ...
    if (result[0].affectedRows === 0) {
      return next(
        new errorResponse_1.default("There is no game with that id", 404)
      );
    }
    res.status(201).json({
      success: true,
